...
- However, by the time the reviewers get back to you, you can't remember exactly each step you went through, or if in the meantime you updated your data files. How are you going to do? 
- By generating the results and report from code with R Markdown, you, and others, *can always reproduce your results, and easily update new data in the workflow*.
