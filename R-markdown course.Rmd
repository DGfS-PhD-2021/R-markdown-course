...
You send the paper to a journal and the reviewers request some modifications.
However, what if you can't remember each step you went through, or if in the meantime you updated your data files? If you  need to update manually all the numbers to match  and aren't able to reproduce your work! By generating the results and report from code with R Markdown, you, and others, *can always reproduce your results*.
