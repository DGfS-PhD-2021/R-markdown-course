...
<!-- As you have seen, you can easily create tables in markdown. One way to do this is to input it manually, using Markdown syntax. This allows you to create a table indipendently of what is or is not in your environment. -->
<!-- Also, you don't need code to insert a markdown table. -->
...
either inputting them manually, or 
